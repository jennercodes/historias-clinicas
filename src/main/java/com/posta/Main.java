...
// Demo de consola que ejercita la logica de negocio de la Fase 4 de extremo a
// extremo (login, alta de pacientes, registro de atenciones y reportes).
// La interfaz grafica Swing se construye en la Fase 5; aqui solo se valida que
// los servicios funcionan sobre las estructuras y la persistencia.
public class Main {
